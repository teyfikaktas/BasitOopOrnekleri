...
public  class OpeningScene {
    static public String WelcomeText= "Hello, Welcome. " +
            ...
            "\n" +
            "You can type \"info\" to see this article again., you can write \"info\"." +
            ...
            "Do not forget! Lists start from 0" +
            "As elements are added to the list, the added elements are saved at the first index.\n" +
